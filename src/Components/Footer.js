                    ...
                    <div className="footer-content">
                        ...
                        <div className="footer-content-column">
                            <div className="footer-menu">
                                ...
                                <ul id="menu-quick-links" className="footer-menu-list">
                                    ...
                                    <li className="menu-item menu-item-type-custom menu-item-object-custom">
                                        <a target="_blank" rel="noopener noreferrer" href="#contact">Service Status</a>
                                    </li>
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page">
                                        <a href="/">Security</a>
                                    </li>
                        ...
                        <div className="footer-content-column">
                            <div className="footer-call-to-action">
                                ...
                                <a className="footer-call-to-action-button button" href="#contact" target="_self"> Get in Touch </a>
                            </div>
                            <div className="footer-call-to-action">
                                <h2 className="footer-call-to-action-title"> You Call Us</h2>
                                <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="tel:0124-64XXXX" target="_self">91+ 9170XXXX62 </a></p>
                            </div>
                        </div>
                        <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
                            ...
                            <a className="footer-social-link linkedin" href="https://www.linkedin.com/in/mdsaif03/" target="_blank">
                            ...
                            <a className="footer-social-link twitter" href="https://twitter.com/MDSAIF58586703?t=U3iau-lpwSyfYYqs875aEg&s=09" target="_blank">
                            ...
                            <a className="footer-social-link youtube" href="https://www.youtube.com/@saifu.nentertainment3021" target="_blank">
                            ...
                            <a className="footer-social-link github" href="https://github.com/12saif" target="_blank">
                    ...
                    <div className="footer-copyright">
                        <div className="footer-copyright-wrapper">
                            <p className="footer-copyright-text">
                                <a className="footer-copyright-link" href="/" target="_self"> ©2022. || Designed By: MD SAIF. || All rights reserved.</a>
                            </p>
                        </div>
                    </div>
                </footer>
